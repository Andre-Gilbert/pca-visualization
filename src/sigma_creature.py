...
class Eyes(VMobject):
    ...
    def create_eyes(self, eye_radius: float = 0.2):
        ...
        left_pupil = Circle(color=BLACK, radius=eye_radius*0.28, fill_opacity=1).shift(0.18 * eye_radius * UP + 0.2 * eye_radius * LEFT)
        left_pupil_reflection = Circle(color=WHITE, radius=eye_radius*0.03, fill_opacity=1).shift(0.12 * eye_radius * UP + 0.3 * eye_radius * LEFT)
        ...
        right_pupil = Circle(color=BLACK, radius=eye_radius*0.28, fill_opacity=1).shift(0.18 * eye_radius * UP + 0.2 * eye_radius * LEFT)
        right_pupil_reflection = Circle(color=WHITE, radius=eye_radius*0.03, fill_opacity=1).shift(0.12 * eye_radius * UP + 0.3 * eye_radius * LEFT)
